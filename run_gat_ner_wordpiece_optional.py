...
Flag_network = 3  # Flag_network  0:bert-gat-bilstm-crf, 1:bert-bilstm-gat-crf, 2:bert-gat-crf, 3:bert-bilstm-crf, 4:bert-crf
...
flags.DEFINE_integer(
    "num_gat_units", 64,
    "The number of units of each head in multi-head graph attention network."
)

flags.DEFINE_float(
    "dropout_rate_of_gat", 0.0,
    "The dropout rate of multi-head graph attention network."
)
...
def create_model_init(bert_config, is_training, input_ids, input_mask,
                 segment_ids, labels, num_labels, use_one_hot_embeddings,
                 bias_matrix, syntactic_feature_matrix,
                 num_gat_heads, num_gat_units, dropout_rate_of_gat,
                 dropout_rate=1.0, lstm_size=512, cell='lstm', num_layers=1):
    model = modeling.BertModel(
        config=bert_config,
        is_training=is_training,
    ...
    gat_bilstm_crf = GAT_BILSTM_CRF(embedded_chars=output_layer, hidden_unit=lstm_size, cell_type=cell, num_layers=num_layers,
                          ...
                          seq_length=max_seq_length, labels=labels, lengths=lengths, is_training=is_training,
                          bias_matrix=bias_matrix, syntactic_feature_matrix=syntactic_feature_matrix,
                          num_gat_heads=num_gat_heads, num_gat_units=num_gat_units, dropout_rate_of_gat=dropout_rate_of_gat)
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
                     ...
                     use_one_hot_embeddings, num_gat_heads, num_gat_units, dropout_rate_of_gat):
